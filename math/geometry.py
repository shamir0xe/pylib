...
class Geometry:
    ...
    def side_sign(p1, p2, p3):
        ...
        if math.fabs(sign) < Geometry.epsilon:
            return 0
        if sign > 0:
            return +1
        return -1
    ...
    class Point:
        ...
        def __lt__(self, other):
            if math.fabs(self.x - other.x) < Geometry.epsilon:
                return self.y + Geometry.epsilon < other.y
            return self.x + Geometry.epsilon < other.x

        def __eq__(self, other):
            return (
                math.fabs(self.x - other.x) < Geometry.epsilon
                and math.fabs(self.y - other.y) < Geometry.epsilon
            )
        ...
        @staticmethod
        def is_lower(p1, p2):
            if p1.x - p2.x < Geometry.epsilon:
                if p1.y - p2.y < Geometry.epsilon:
                    return 0
                return p1.y < p2.y
            return p1.x < p2.y
        ...
        def is_equal(p1, p2):
            return (
                math.fabs(p1.x - p2.x) < Geometry.epsilon
                and math.fabs(p1.y - p2.y) < Geometry.epsilon
            )
